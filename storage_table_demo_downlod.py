...
resourcegroup_name = 'skj'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'skj'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
cars = Entity()
cars.PartitionKey = 'Model'
cars.RowKey = '001'
cars.description = 'Honda'
cars.cost = 18000
...
Coffee = Entity()
Coffee.PartitionKey = 'brand'
Coffee.RowKey = '005'
Coffee.sku = 'NF203123'
Coffee.item = 'Nescafe'
Coffee.cost = 11.99
table_service.insert_entity('itemstable', Coffee)
print('Created entry for a Nescafe...\n')
time.sleep(1)
...
Coffee.cost = 9.99
table_service.insert_entity('itemstable', Coffee)
print('Created entry for Bruster...\n')
time.sleep(1)
